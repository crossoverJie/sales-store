...
<body class="">
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-md-12">
				<img src="<%=path %>/${produce.path }"
					class="img-responsive center-block img-circle"
					alt="Responsive image">
				<blockquote>
					<p class="text-center text-danger">${produce.remark }</p>
				</blockquote>
			</div>
		</div>
		<hr />
		<form id="buyProduceForm" action="<%=path%>/main/createAchat" method="post">
			...
			<div class="form-group">
				<label>备注</label>
				<textarea rows="" cols="" class="form-control" required="required"
				name="content"	placeholder="备注"></textarea>
				<input type="hidden" id="session_username" value="${user.username }" />
				<input type="hidden" name="category_id" value="${produce.category_id }" />
			</div>
			<p class="text-right">
