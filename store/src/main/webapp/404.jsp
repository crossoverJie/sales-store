...
<link rel="stylesheet" href="<%=path %>/css/main.css" type="text/css" media="screen, projection" /> <!-- main stylesheet -->
<link rel="stylesheet" type="text/css" media="all" href="<%=path %>/css/tipsy.css" /> <!-- Tipsy implementation -->

<!--[if lt IE 9]>
	<link rel="stylesheet" type="text/css" href="css/ie8.css" />
<![endif]-->

<script type="text/javascript" src="<%=path %>/scripts/jquery-1.7.2.min.js"></script> <!-- uiToTop implementation -->
<script type="text/javascript" src="<%=path %>/scripts/custom-scripts.js"></script>
<script type="text/javascript" src="<%=path %>/scripts/jquery.tipsy.js"></script> <!-- Tipsy -->
...
<div id="universal-preloader">
    <div class="preloader">
        <img src="<%=path %>/images/universal-preloader.gif" alt="universal-preloader" class="universal-preloader-preloader" />
    </div>
</div>
<!-- Universal preloader -->
